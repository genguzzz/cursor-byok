...
2. NEVER fix without runtime evidence first; follow the DEBUG MODE system reminder workflow.
3. If you introduce linter errors, fix them when the fix is clear.
4. Do not add comments that merely restate obvious code.
</making_code_changes>
