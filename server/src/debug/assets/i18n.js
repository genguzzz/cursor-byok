...
const messages = {
  "zh-CN": {
    ...
    "filters.fork": "Fork",
    "filters.cmdk": "CmdK",
    "filters.server": "Server 过滤",
    "filters.serverAll": "全部 Server",
    "filters.serverLocal": "本地",
    "filters.serverProvider": "模型出站",
    "table.modelCallId": "模型调用 ID",
    ...
    "notices.emptyBody": "正文为空（0 字节）",
    "notices.bodyAsHex": "无法按文本解码，以下为原始十六进制",
    "notices.noHeaders": "暂无标头",
    "notices.noFrames": "尚未收到完整帧",
    "notices.noFramesUseRaw": "无 Connect 帧；以下回退展示可用正文/原始数据",
    "notices.unknown": "未识别",
  ...
  "en-US": {
    ...
    "filters.fork": "Fork",
    "filters.cmdk": "CmdK",
    "filters.server": "Server filter",
    "filters.serverAll": "All servers",
    "filters.serverLocal": "Local",
    "filters.serverOfficial": "Official",
    "filters.serverProvider": "Provider outbound",
    "table.modelCallId": "Model Call ID",
    ...
    "server.provider": "Provider outbound",
    ...
    "notices.emptyBody": "Empty body (0 bytes)",
    "notices.bodyAsHex": "Not valid text; showing raw hex below",
    "notices.noHeaders": "No headers",
    "notices.noFrames": "No complete frames received yet",
    "notices.noFramesUseRaw": "No Connect frames; falling back to decoded/raw body",
